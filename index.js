(function() {
  ...
  const _sfc_main$a = {
    ...
    methods: {
      ...
      isItemContentFieldEnabled(blockType, fieldKey) {
        ...
        const disabled = ov && ov.settings && ov.settings.fields && ov.settings.fields.content && ov.settings.fields.content[fieldKey] && ov.settings.fields.content[fieldKey]._disabled;
  ...
  var _sfc_render$a = function render() {
    ...
    return _c("k-panel-inside", { staticClass: "pw-wizard" }, [_c("k-header", { scopedSlots: _vm._u([_vm.isDirty ? { key: "buttons", fn: function() {
    ...
    }), 0) : _vm._e(), !_vm.loading && _vm.activeTab !== "global" ? _c("nav", { staticClass: "k-tabs k-model-tabs" }, _vm._l(_vm.blockTabs(_vm.activeTab), function(tab) {
      return _c("button", { key: tab.key, staticClass: "k-tabs-button k-button", attrs: { "type": "button", "aria-current": _vm.blockViewTab === tab.key ? "true" : null, "data-has-icon": "true", "data-has-text": "true", "data-variant": "dimmed" }, on: { "click": function($event) {
        _vm.blockViewTab = tab.key;
      } } }, [_c("span", { staticClass: "k-button-icon" }, [_c("k-icon", { attrs: { "type": tab.icon } })], 1), _c("span", { staticClass: "k-button-text" }, [_vm._v(_vm._s(_vm.$t("prw.tab." + tab.key)))])]);
      ...
      return _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.activeTab === block.blockType, expression: "activeTab === block.blockType" }], key: block.blockType, staticClass: "pw-wizard-panel" }, [_vm.blockConfigs[block.blockType] ? _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.blockViewTab === "defaults", expression: "blockViewTab === 'defaults'" }] }, [_c("pw-block-settings", { attrs: { "view": "defaults", "block": block, "config": _vm.blockConfigs[block.blockType], "overrides": _vm.blockOverrides[block.blockType] || {}, "writer-active": _vm.writerActive[block.blockType] !== false }, on: { "update:overrides": function($event) {
      ...
      } } })], 1) : _vm._e(), _vm.blockConfigs[block.blockType] && _vm.hasItemFields(block.blockType) ? _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.blockViewTab === "items", expression: "blockViewTab === 'items'" }] }, [_c("pw-block-settings", { attrs: { "view": "items", "block": block, "config": _vm.blockConfigs[block.blockType], "overrides": _vm.blockOverrides[block.blockType] || {}, "writer-active": _vm.writerActive[block.blockType] !== false }, on: { "update:overrides": function($event) {
        return _vm.onBlockOverridesUpdate(block.blockType, $event);
      }, "update:writer-active": function($event) {
        return _vm.$set(_vm.writerActive, block.blockType, $event);
      } } }), _vm.blockValueDefaults[block.blockType] ? _c("section", { staticClass: "pw-wizard-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
        return _vm.toggleItemSection(block.blockType, "defaults");
      } } }, [_c("span", [_vm._v(_vm._s(_vm.$t("prw.tab.defaults") || "Defaults"))]), _c("k-icon", { attrs: { "type": _vm.isItemSectionOpen(block.blockType, "defaults") ? "angle-down" : "angle-right" } })], 1)]), _c("transition", { attrs: { "name": "pw-slide" } }, [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isItemSectionOpen(block.blockType, "defaults"), expression: "isItemSectionOpen(block.blockType, 'defaults')" }], staticClass: "pw-field-block", attrs: { "data-collapsible": "true" } }, [_c("pw-block-settings", { attrs: { "view": "items-defaults", "block": block, "config": _vm.blockConfigs[block.blockType], "overrides": _vm.blockOverrides[block.blockType] || {}, "writer-active": _vm.writerActive[block.blockType] !== false }, on: { "update:overrides": function($event) {
        return _vm.onBlockOverridesUpdate(block.blockType, $event);
      }, "update:writer-active": function($event) {
        return _vm.$set(_vm.writerActive, block.blockType, $event);
      } } })], 1)])], 1) : _vm._e(), _vm.blockValueDefaults[block.blockType] ? _c("section", { staticClass: "pw-wizard-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
        return _vm.toggleItemSection(block.blockType, "layout");
      } } }, [_c("span", [_vm._v(_vm._s(_vm.$t("prw.subtab.layout") || "Layout"))]), _c("k-icon", { attrs: { "type": _vm.isItemSectionOpen(block.blockType, "layout") ? "angle-down" : "angle-right" } })], 1)]), _c("transition", { attrs: { "name": "pw-slide" } }, [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isItemSectionOpen(block.blockType, "layout"), expression: "isItemSectionOpen(block.blockType, 'layout')" }], staticClass: "pw-field-block pw-items-layout-stack", attrs: { "data-collapsible": "true" } }, [_c("pw-block-values", { attrs: { "defaults": _vm.blockValueDefaults[block.blockType], "overrides": _vm.blockValueOverrides[block.blockType] || {}, "show-only": ["item-padding"], "hide-section-headers": true }, on: { "update:overrides": function($event) {
        return _vm.onBlockValueOverridesUpdate(block.blockType, $event);
      } } }), _c("pw-block-values", { attrs: { "defaults": _vm.blockValueDefaults[block.blockType], "overrides": _vm.blockValueOverrides[block.blockType] || {}, "show-only": ["item-radius"], "hide-section-headers": true }, on: { "update:overrides": function($event) {
        return _vm.onBlockValueOverridesUpdate(block.blockType, $event);
        ...
        return _vm.$set(_vm.writerActive, block.blockType, $event);
      } } }), _vm.isItemBorderEnabled(block.blockType) ? _c("pw-block-values", { attrs: { "defaults": _vm.blockValueDefaults[block.blockType], "overrides": _vm.blockValueOverrides[block.blockType] || {}, "show-only": ["item-border-width"], "hide-section-headers": true }, on: { "update:overrides": function($event) {
        return _vm.onBlockValueOverridesUpdate(block.blockType, $event);
        ...
        return _vm.$set(_vm.writerActive, block.blockType, $event);
      } } }) : _vm._e()], 1)])], 1) : _vm._e(), _vm.blockValueDefaults[block.blockType] ? _c("section", { staticClass: "pw-wizard-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
        return _vm.toggleItemSection(block.blockType, "colors");
      } } }, [_c("span", [_vm._v(_vm._s(_vm.$t("prw.subtab.colors") || "Colors"))]), _c("k-icon", { attrs: { "type": _vm.isItemSectionOpen(block.blockType, "colors") ? "angle-down" : "angle-right" } })], 1)]), _c("transition", { attrs: { "name": "pw-slide" } }, [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isItemSectionOpen(block.blockType, "colors"), expression: "isItemSectionOpen(block.blockType, 'colors')" }], staticClass: "pw-field-block", attrs: { "data-collapsible": "true" } }, [_c("pw-block-values", { attrs: { "defaults": _vm.blockValueDefaults[block.blockType], "overrides": _vm.blockValueOverrides[block.blockType] || {}, "show-only": _vm.itemColorsShowOnly(block.blockType), "hide-section-headers": true }, on: { "update:overrides": function($event) {
        return _vm.onBlockValueOverridesUpdate(block.blockType, $event);
      } } })], 1)])], 1) : _vm._e()], 1) : _vm._e(), _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.blockViewTab === "layout", expression: "blockViewTab === 'layout'" }] }, [_c("div", { staticClass: "pw-wizard-empty" }, [_c("p", [_vm._v(_vm._s(_vm.$t("prw.tab.layout.placeholder") || "Layout configuration for this block will appear here."))])])])]);
    })], 2)], 1);
  };
  ...
  __component__$a.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/Overview.vue";
  const Overview = __component__$a.exports;
  const _sfc_main$9 = {
    props: {
      uid: String,
      label: String,
  ...
  __component__$9.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/FieldRow.vue";
  const FieldRow = __component__$9.exports;
  const _sfc_main$8 = {
    props: {
      group: String,
      varName: String,
  ...
  __component__$8.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/ColorFieldRow.vue";
  const ColorFieldRow = __component__$8.exports;
  const _sfc_main$7 = {
    props: {
      blocks: {
        type: Array,
  ...
  var _sfc_render$7 = function render() {
    ...
    return _c("div", [_vm._l(_vm.groups, function(group) {
      return [group.blocks.length ? _c("section", { key: group.key, staticClass: "pw-element-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
        _vm.$set(_vm.open, group.key, !_vm.isOpen(group.key));
      } } }, [_c("span", [_vm._v(_vm._s(group.label))]), _c("k-icon", { attrs: { "type": _vm.isOpen(group.key) ? "angle-down" : "angle-right" } })], 1)]), _c("transition", { attrs: { "name": "pw-slide" } }, [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isOpen(group.key), expression: "isOpen(group.key)" }], staticClass: "pw-element-list" }, _vm._l(group.blocks, function(block) {
  ...
  __component__$7.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/GlobalElements.vue";
  const GlobalElements = __component__$7.exports;
  const _sfc_main$6 = {
    props: {
      block: {
        type: Object,
  ...
  var _sfc_render$6 = function render() {
    ...
    return _c("div", { staticClass: "pw-wizard-block-sections" }, [_vm.view === "defaults" || _vm.view === "layout" ? _c("div", { staticClass: "pw-wizard-tab-content" }, [_vm.view === "defaults" ? _c("section", { staticClass: "pw-wizard-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("span", { staticClass: "pw-tab-visibility pw-tab-visibility-static" }, [_c("svg", { attrs: { "xmlns": "http://www.w3.org/2000/svg", "viewBox": "0 0 24 24", "fill": "currentColor" } }, [_c("path", { attrs: { "d": "M1.18164 12C2.12215 6.87976 6.60812 3 12.0003 3C17.3924 3 21.8784 6.87976 22.8189 12C21.8784 17.1202 17.3924 21 12.0003 21C6.60812 21 2.12215 17.1202 1.18164 12ZM12.0003 17C14.7617 17 17.0003 14.7614 17.0003 12C17.0003 9.23858 14.7617 7 12.0003 7C9.23884 7 7.00026 9.23858 7.00026 12C7.00026 14.7614 9.23884 17 12.0003 17ZM12.0003 15C10.3434 15 9.00026 13.6569 9.00026 12C9.00026 10.3431 10.3434 9 12.0003 9C13.6571 9 15.0003 10.3431 15.0003 12C15.0003 13.6569 13.6571 15 12.0003 15Z" } })])]), _c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
    ...
    })], 2)]) : _vm._e(), _vm.getItemDefaultsContentFields().length ? _c("div", { staticClass: "pw-field-block" }, _vm._l(_vm.getItemDefaultsContentFields(), function(field) {
      return _c("div", { key: field.key, staticClass: "k-field k-text-field pw-content-field", attrs: { "data-object": "content-field" } }, [_c("div", { staticClass: "pw-column-field-label pw-clickable", on: { "click": function($event) {
        _vm.toggleField(field, !_vm.isFieldEnabled(field));
      } } }, [_c("span", { staticClass: "pw-tab-visibility" }, [_c("k-icon", { attrs: { "type": _vm.isFieldEnabled(field) ? "preview" : "hidden" } })], 1), _c("span", [_vm._v(_vm._s(_vm.fieldLabel(field.key)))])]), field.properties.length ? _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isFieldEnabled(field), expression: "isFieldEnabled(field)" }], staticClass: "pw-field-rows" }, _vm._l(field.properties, function(prop) {
        return _c("pw-field-row", { key: field.key + "-" + prop.key, attrs: { "uid": _vm.blockType + "-" + field.key + "-" + prop.key, "label": prop.key, "all-options": prop.allOptions, "active-options": _vm.getActiveOptions(field.key, prop.key, prop), "current-default": _vm.getVal("settings.fields.content." + field.key + "." + prop.key + ".default", prop.pluginDefault), "plugin-default": prop.pluginDefault, "enabled": true, "required": prop.required === true, "modified": _vm.hasOverride("settings.fields.content." + field.key + "." + prop.key) }, on: { "update:options": function($event) {
          return _vm.setActiveOptions(field.key, prop.key, prop, $event);
        }, "update:default": function($event) {
          return _vm.selectOption("settings.fields.content." + field.key + "." + prop.key + ".default", $event, prop.pluginDefault);
    ...
    }), 0) : _vm._e()])])], 1) : _vm._e(), _vm._l(_vm.getCategories(), function(cat) {
    ...
    })], 2) : _vm._e(), _vm.view === "items" || _vm.view === "items-defaults" || _vm.view === "items-layout" ? _c("div", { staticClass: "pw-wizard-tab-content" }, [_vm.view === "items" && _vm.getItemContentFields().length ? _c("section", { staticClass: "pw-wizard-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("span", { staticClass: "pw-tab-visibility pw-tab-visibility-static" }, [_c("svg", { attrs: { "xmlns": "http://www.w3.org/2000/svg", "viewBox": "0 0 24 24", "fill": "currentColor" } }, [_c("path", { attrs: { "d": "M1.18164 12C2.12215 6.87976 6.60812 3 12.0003 3C17.3924 3 21.8784 6.87976 22.8189 12C21.8784 17.1202 17.3924 21 12.0003 21C6.60812 21 2.12215 17.1202 1.18164 12ZM12.0003 17C14.7617 17 17.0003 14.7614 17.0003 12C17.0003 9.23858 14.7617 7 12.0003 7C9.23884 7 7.00026 9.23858 7.00026 12C7.00026 14.7614 9.23884 17 12.0003 17ZM12.0003 15C10.3434 15 9.00026 13.6569 9.00026 12C9.00026 10.3431 10.3434 9 12.0003 9C13.6571 9 15.0003 10.3431 15.0003 12C15.0003 13.6569 13.6571 15 12.0003 15Z" } })])]), _c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
      return _vm.toggleSection("items-content");
    } } }, [_c("span", [_vm._v(_vm._s(_vm.$t("pw.headline.content")))]), _c("k-icon", { attrs: { "type": _vm.isSectionOpen("items-content") ? "angle-down" : "angle-right" } })], 1)]), _c("transition", { attrs: { "name": "pw-slide" } }, [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isSectionOpen("items-content"), expression: "isSectionOpen('items-content')" }], staticClass: "pw-field-block", attrs: { "data-collapsible": "true" } }, [_vm.getItemContentFields().length ? _c("div", { staticClass: "pw-item-section" }, [_c("div", { staticClass: "pw-field-block" }, _vm._l(_vm.getItemContentFields(), function(field) {
      return _c("div", { key: field.key, staticClass: "k-field k-text-field pw-content-field", attrs: { "data-object": "content-field" } }, [_c("div", { staticClass: "pw-column-field-label pw-clickable", on: { "click": function($event) {
        _vm.toggleField(field, !_vm.isFieldEnabled(field));
    ...
    }), 0)]) : _vm._e()])])], 1) : _vm._e(), _vm.getItemLayoutFields().length ? _c("section", { staticClass: "pw-wizard-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("span", { staticClass: "pw-tab-visibility pw-tab-visibility-static" }, [_c("k-icon", { attrs: { "type": "layout-top" } })], 1), _c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
      return _vm.toggleSection("items-layout");
    } } }, [_c("span", [_vm._v(_vm._s(_vm.$t("prw.tab.layout") || "Layout"))]), _c("k-icon", { attrs: { "type": _vm.isSectionOpen("items-layout") ? "angle-down" : "angle-right" } })], 1)]), _c("transition", { attrs: { "name": "pw-slide" } }, [_c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isSectionOpen("items-layout"), expression: "isSectionOpen('items-layout')" }], staticClass: "pw-field-block", attrs: { "data-collapsible": "true" } }, _vm._l(_vm.getItemLayoutFields(), function(field) {
      return _c("div", { key: field.key, staticClass: "pw-field-row" }, [_c("div", { staticClass: "k-input", attrs: { "data-type": "text" } }, [_c("span", { staticClass: "k-input-element pw-field-row-inner" }, [_c("div", { staticClass: "pw-field-row-label-col" }, [_c("label", { staticClass: "pw-field-row-label" }, [_vm._v(_vm._s(_vm.fieldLabel(field.displayKey)))])]), _c("div", { staticClass: "pw-field-row-options" }, [typeof field.defaultValue === "boolean" ? _c("k-toggle-input", { attrs: { "value": _vm.getVal("settings.fields.content." + field.key + ".default", field.defaultValue), "text": [_vm.$t("pw.option.disabled"), _vm.$t("pw.option.enabled")] }, on: { "input": function($event) {
        return _vm.setVal("settings.fields.content." + field.key + ".default", $event);
      } } }) : _c("input", { staticClass: "pw-category-input", attrs: { "type": "text", "placeholder": String(field.defaultValue) }, domProps: { "value": _vm.getOverrideOnly("settings.fields.content." + field.key + ".default") || "" }, on: { "input": function($event) {
        return _vm.setValOrClear("settings.fields.content." + field.key + ".default", $event.target.value, field.defaultValue);
      } } })], 1)])])]);
    }), 0)])], 1) : _vm._e(), _vm.view === "items-defaults" && _vm.getItemRadiusFields().length ? _c("div", { staticClass: "pw-field-block" }, _vm._l(_vm.getItemRadiusFields(), function(field) {
      return _c("div", { key: field.key, staticClass: "pw-field-row" }, [_c("div", { staticClass: "k-input", attrs: { "data-type": "text" } }, [_c("span", { staticClass: "k-input-element pw-field-row-inner" }, [_c("div", { staticClass: "pw-field-row-label-col" }, [_c("label", { staticClass: "pw-field-row-label" }, [_vm._v(_vm._s(_vm.fieldLabel(field.displayKey)))])]), _c("div", { staticClass: "pw-field-row-options", class: { "pw-toggle-group": field.type === "toggle-group" } }, _vm._l(field.subFields, function(sub) {
        return _c("k-toggle-input", { key: sub.key, attrs: { "value": _vm.getVal("settings.fields.layout." + sub.key + ".default", sub.defaultValue), "text": _vm.toggleOptionLabel(sub.label) }, on: { "input": function($event) {
  ...
  __component__$6.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/BlockSettings.vue";
  const BlockSettings = __component__$6.exports;
  const _sfc_main$5 = {
    props: {
      fontDefaults: {
        type: Object,
    ...
    return _c("div", [_c("div", { staticClass: "pw-font-help", staticStyle: { "margin-bottom": "var(--spacing-4)" } }, [_vm._v(' These sizes are used when the "sizes" option is enabled in block settings. Otherwise, the font-size from the Elements tab is used as fallback. ')]), _vm._l(_vm.groups, function(group, groupKey) {
      return _c("section", { key: groupKey, staticClass: "pw-element-section" }, [_c("div", { staticClass: "pw-section-header" }, [_c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
        ...
        return _c("div", { key: varName, staticClass: "pw-field-row" }, [_c("div", { staticClass: "k-input", attrs: { "data-type": "text" } }, [_c("span", { staticClass: "k-input-element pw-field-row-inner" }, [_c("div", { staticClass: "pw-field-row-label-col" }, [_c("label", { staticClass: "pw-field-row-label" }, [_vm._v(_vm._s(_vm.sizeLabel(varName)))])]), _c("div", { staticClass: "pw-field-row-options pw-group-type-responsive" }, _vm._l(["default", "lg", "xl"], function(bp) {
          return _c("span", { key: bp, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", class: { "is-default": !_vm.getOverrideValue(bp, varName) }, attrs: { "type": "text", "inputmode": "decimal", "step": group.step || 0.1, "min": "0.1", "max": "20" }, domProps: { "value": _vm.stripRem(_vm.getOverrideValue(bp, varName) || value[bp]) }, on: { "change": function($event) {
  ...
  __component__$5.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/GlobalFonts.vue";
  const GlobalFonts = __component__$5.exports;
  const _sfc_main$4 = {
    props: {
      elementDefaults: {
        type: Object,
      ...
      return _c("section", { directives: [{ name: "show", rawName: "v-show", value: _vm.isElementVisible(groupKey) && !_vm.isChildElement(groupKey), expression: "isElementVisible(groupKey) && !isChildElement(groupKey)" }], key: groupKey, staticClass: "pw-element-section" }, [_c("div", { staticClass: "pw-element-list" }, [_vm.previewText(groupKey) && !_vm.isChildElement(groupKey) ? [_c("div", { staticClass: "pw-element-preview-header" }, _vm._l(["default", "lg", "xl"], function(bp) {
        ...
        return [fieldGroup.header ? _c("div", { key: "vgh-" + gIdx, staticClass: "pw-group-header" }, [_c("div", { staticClass: "pw-field-row-label-col" }), _c("div", { staticClass: "pw-group-header-labels", class: "pw-group-type-" + fieldGroup.fieldType }, _vm._l(fieldGroup.header, function(label) {
          ...
          return [_c("div", { key: "vf-" + gIdx + "-" + fIdx, staticClass: "pw-field-row", class: {
            ...
            return _c("span", { key: idx, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", attrs: { "type": "text", "inputmode": "decimal", "step": field.def.step || 0.1, "min": field.def.min, "max": field.def.max }, domProps: { "value": _vm.stripUnit(_vm.getQuadValue(field.varName, idx) || val) }, on: { "change": function($event) {
            ...
            return _c("span", { key: bp, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", attrs: { "type": "text", "inputmode": "decimal", "step": field.def.step || 0.1, "min": field.def.min, "max": field.def.max }, domProps: { "value": _vm.stripUnit(_vm.getResponsiveOverride(field.varName, bp) || field.def[bp]) }, on: { "change": function($event) {
          ...
          }) : field.def.unit !== void 0 ? [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", attrs: { "type": "text", "inputmode": "decimal", "step": field.def.step || 0.1, "min": field.def.min, "max": field.def.max }, domProps: { "value": _vm.stripUnit(_vm.getOverrideValue(field.varName) || field.def.value) }, on: { "change": function($event) {
        ...
        return [fieldGroup.header ? _c("div", { key: "gh-" + gIdx, staticClass: "pw-group-header" }, [_c("div", { staticClass: "pw-field-row-label-col" }), _c("div", { staticClass: "pw-group-header-labels", class: "pw-group-type-" + fieldGroup.fieldType }, _vm._l(fieldGroup.header, function(label) {
          ...
          return [_c("div", { key: "gf-" + gIdx + "-" + fIdx, staticClass: "pw-field-row", class: {
            ...
            return _c("span", { key: idx, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", class: { "is-default": !_vm.getQuadValue(field.varName, idx) }, attrs: { "type": "text", "inputmode": "decimal", "step": field.def.step || 0.1, "min": field.def.min, "max": field.def.max }, domProps: { "value": _vm.stripUnit(_vm.getQuadValue(field.varName, idx) || val) }, on: { "change": function($event) {
              return _vm.setQuadValue(field.varName, idx, $event.target.value, field.def);
            ...
            return _c("span", { key: bp, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", class: { "is-default": !_vm.getResponsiveOverride(field.varName, bp) }, attrs: { "type": "text", "inputmode": "decimal", "step": field.def.step || 0.1, "min": field.def.min, "max": field.def.max }, domProps: { "value": _vm.stripUnit(_vm.getResponsiveOverride(field.varName, bp) || field.def[bp]) }, on: { "change": function($event) {
              return _vm.setResponsiveValue(field.varName, bp, $event.target.value, field.def[bp], field.def.unit);
          ...
          }) : field.def.unit !== void 0 ? [_c("span", { staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number pw-px-calculator-input", class: { "is-default": !_vm.getOverrideValue(field.varName) }, attrs: { "type": "text", "inputmode": "decimal", "step": field.def.step || 0.1, "min": field.def.min, "max": field.def.max }, domProps: { "value": _vm.stripUnit(_vm.getOverrideValue(field.varName) || field.def.value) }, on: { "change": function($event) {
            return _vm.setUnitValue(field.varName, $event.target.value, field.def.value, field.def.unit);
  ...
  __component__$4.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/GlobalElementStyles.vue";
  const GlobalElementStyles = __component__$4.exports;
  const _sfc_main$3 = {
    props: {
      navDefaults: {
        type: Object,
  ...
  __component__$3.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/GlobalNavigation.vue";
  const GlobalNavigation = __component__$3.exports;
  const _sfc_main$2 = {
    props: {
  ...
  __component__$2.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/GlobalFontManager.vue";
  const GlobalFontManager = __component__$2.exports;
  const _sfc_main$1 = {
    props: {
  ...
  var _sfc_render$1 = function render() {
    ...
    return _c("div", _vm._l(_vm.groups, function(group, groupKey) {
      return _c("section", { key: groupKey, staticClass: "pw-element-section" }, [!_vm.hideSectionHeaders ? _c("div", { staticClass: "pw-section-header" }, [_c("span", { staticClass: "pw-tab-visibility pw-tab-visibility-static" }, [_c("k-icon", { attrs: { "type": "settings" } })], 1), _c("button", { staticClass: "pw-section-toggle", on: { "click": function($event) {
        ...
        return _c("div", { key: varName, staticClass: "pw-field-row" }, [_c("div", { staticClass: "k-input", attrs: { "data-type": "text" } }, [_c("span", { staticClass: "k-input-element pw-field-row-inner" }, [_c("div", { staticClass: "pw-field-row-label-col" }, [_c("label", { staticClass: "pw-field-row-label", domProps: { "innerHTML": _vm._s(_vm.varLabel(varName)) } })]), _c("div", { staticClass: "pw-field-row-options" }, [def.type === "color" ? [_c("pw-color-field-row", { attrs: { "group": "block-values", "var-name": varName, "default-value": def.value, "override-value": _vm.getOverride(varName) || "" }, on: { "update:value": function($event) {
          return _vm.setSingle(varName, $event || "", def.value);
        } } })] : Array.isArray(def.value) && def.suffixes ? _vm._l(def.suffixes, function(suffix, idx) {
          return _c("span", { key: suffix, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number", class: { "pw-px-calculator-input": _vm.showCalculator(def.unit), "is-default": !_vm.overrideAt(varName, idx) }, attrs: { "type": "text", "inputmode": "decimal" }, domProps: { "value": _vm.stripUnit(_vm.overrideAt(varName, idx) || def.value[idx], def.unit) }, on: { "change": function($event) {
          ...
          return _c("span", { key: idx, staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number", class: { "pw-px-calculator-input": _vm.showCalculator(def.unit) }, attrs: { "type": "text", "inputmode": "decimal" }, domProps: { "value": _vm.stripUnit(_vm.overrideAt(varName, idx) || def.value[idx], def.unit) }, on: { "change": function($event) {
            return _vm.setMulti(varName, idx, $event.target.value, def.value, def.unit);
          } } }), _c("span", { staticClass: "pw-element-unit" }, [_vm._v(_vm._s(def.unit))])]), _vm.showCalculator(def.unit) ? _c("span", { staticClass: "pw-px-calculator" }, [_vm._v(_vm._s(_vm.toPx(_vm.overrideAt(varName, idx) || def.value[idx], def.unit)))]) : _vm._e()]);
        }) : [_c("span", { staticClass: "pw-element-field" }, [_c("span", { staticClass: "pw-element-input-wrap" }, [_c("input", { staticClass: "pw-element-input pw-element-input-number", class: { "pw-px-calculator-input": _vm.showCalculator(def.unit), "is-default": !_vm.getOverride(varName) }, attrs: { "type": "text", "inputmode": "decimal" }, domProps: { "value": _vm.stripUnit(_vm.getOverride(varName) || def.value, def.unit) }, on: { "change": function($event) {
          return _vm.setSingleUnit(varName, $event.target.value, def.value, def.unit);
        } } }), def.unit ? _c("span", { staticClass: "pw-element-unit" }, [_vm._v(_vm._s(def.unit))]) : _vm._e()]), _vm.showCalculator(def.unit) ? _c("span", { staticClass: "pw-px-calculator" }, [_vm._v(_vm._s(_vm.toPx(_vm.getOverride(varName) || def.value, def.unit)))]) : _vm._e()])]], 2)])])]);
      })], 2)])], 1);
    }), 0);
  };
  ...
  __component__$1.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/components/BlockValues.vue";
  const BlockValues = __component__$1.exports;
  const _sfc_main = {
    data() {
      return {
        projectName: "",
  ...
  __component__.options.__file = "/Users/christian/Projects/pluginsources/kirby-projectwizard/src/views/SetupWizard.vue";
